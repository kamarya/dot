...
" - g:kamary_overrides          (default = {})
" - g:kamary_use_lowcolor_black (default = 0)
" - g:kamary_use_gui_italics    (default = 1)
" - g:kamary_use_term_italics   (default = 0)

let s:background_color = "090c12"

if exists("g:kamary_overrides")
  let s:overrides = g:kamary_overrides
else
  let s:overrides = {}
endif

" Backwards compatibility
if exists("g:kamary_background_color")
  \ || exists("g:kamary_background_color_256")
  \ || exists("g:kamary_use_term_background_color")
  ...
  if exists("g:kamary_background_color")
    let s:overrides["background"]["guibg"] = g:kamary_background_color
  endif

  if exists("g:kamary_background_color_256")
    let s:overrides["background"]["256ctermbg"] = g:kamary_background_color_256
  endif

  if exists("g:kamary_use_term_background_color")
    \ && g:kamary_use_term_background_color
    let s:overrides["background"]["ctermbg"] = "NONE"
    let s:overrides["background"]["256ctermbg"] = "NONE"
  endif
endif

if exists("g:kamary_use_lowcolor_black") && g:kamary_use_lowcolor_black
...
fun! s:X(group, fg, bg, attr, lcfg, lcbg)
  ...
  if exists("g:kamary_use_term_italics") && g:kamary_use_term_italics
    let l:cterm_attr = l:attr
  else
    let l:cterm_attr = s:remove_italic_attr(l:attr)
  endif

  if !exists("g:kamary_use_gui_italics") || g:kamary_use_gui_italics
...
call s:X("Normal","ffffff",s:background_color,"","White","")
set background=dark

call s:X("CursorLine","","232d45","","","")
call s:X("BadWhitespace","","c21807","","",s:termBlack)
...
call s:X("ColorColumn","",s:background_color,"","",s:termBlack)

call s:X("Title","70b950","","bold","Green","")

call s:X("Number","ffa0a0","","","Green","")
call s:X("String","ff82ab","","","Green","")
call s:X("StringDelimiter","556633","","","DarkGreen","")

call s:X("Identifier","b9d3ee","","","LightCyan","")
call s:X("Structure","6495ed","","","LightCyan","")
call s:X("Function","c6e2ff","","","Yellow","")
call s:X("Statement","6495ed","","bold","DarkBlue","")
call s:X("PreProc","ee3a8c","","","LightBlue","")
call s:X("Constant","ffa0a0","","","Red","")
call s:X("Special","ffc0cb","","","Green","")
call s:X("Delimiter","668799","","","Grey","")


call s:X("Include","ee3a8c","","","LightBlue","")
call s:X("Type","7ec0ee","","","Yellow","")
call s:X("NonText","4169e1",s:background_color,"",s:termBlack,"")
call s:X("StorageClass","6ca6cd","","","Red","")
call s:X("Operator","6495ed","","","LightCyan","")
...
call s:X("IncSearch","000000","ffff00","","Yellow","")
call s:X("Search","000000","ffff00","","Yellow","")
...
call s:X("DiffAdd","32CD32",s:background_color,"bold","White","DarkGreen")
call s:X("DiffDelete","FF0000",s:background_color,"bold","DarkRed","DarkRed")
call s:X("DiffChange","FFFF33",s:background_color,"bold","White","DarkBlue")
call s:X("DiffText","",s:background_color,"reverse","Yellow","")
...
call s:X("cConstant","ee1289","","","","")
call s:X("cppConstant","ee1289","","","","")
